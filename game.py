...
class Game:
    def __init__(self):
        ...
        if(rows < 32 or cols < 128):
            ...
            sys.exit(0)
        self._listx=[12,int((self._width/2)),28,int((self._width-15)),int((self._width/2-15)),56,120]
    ...
    def start(self):
        ...
        self._wall_up = Wall([int(self._width/2)-6, int(self._height/2) - 5],  [1, 18], int(1), int(1), [self._width, self._height], int(30), 0)
        ...
        self._king = King([int(6), int(self._height/2)], [1, 1], 2, 2, [self._width, self._height], int(100), 5)
        self._barbarian_p = Barbarian([10,25],[1,1],1,2,[self._width, self._height],int(100),10)
        self._barbarian_p1 = Barbarian([10,25],[1,1],1,2,[self._width, self._height],int(100),10)
        self._barbarian_p2 = Barbarian([10,25],[1,1],1,2,[self._width, self._height],int(100),10)
        
        self._barbarian_k = Barbarian([25,10],[1,1],1,2,[self._width, self._height],int(100),10)
        self._barbarian_k1 = Barbarian([25,10],[1,1],1,2,[self._width, self._height],int(100),10)
        self._barbarian_k2 = Barbarian([25,10],[1,1],1,2,[self._width, self._height],int(100),10)
        
        self._barbarian_l = Barbarian([80,25],[1,1],1,2,[self._width, self._height],int(100),10)
        self._barbarian_l1 = Barbarian([80,25],[1,1],1,2,[self._width, self._height],int(100),10)
        self._barbarian_l2 = Barbarian([80,25],[1,1],1,2,[self._width, self._height],int(100),10)
        
        self._hut1 = Hut([int(12), int(3)], [1 , 1], 1, 1, [  self._width, self._height], int(70), 0)
        ...
        self._listx=[12,int(self._width/2),28,int((self._width-15)),int((self._width-15))]
        self._listy=[3,3,20,3,20]
